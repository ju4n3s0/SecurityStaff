...
from modules.prefilter import should_send_to_gemini
...
class EmailMonitor:
    ...
    def _analyze_single_email(self, message_id: str) -> int:
        ...
        try:
            ...
            try:
                send, reasons = should_send_to_gemini(email_data)
            except Exception:
                send, reasons = True, {}
            ...
            if risk_level == 'dangerous':
                ...
                self.connector.move_to_label(message_id, 'Shield/Peligroso')
                ...
                self.connector.move_to_label(message_id, 'Shield/Sospechoso')
    ...
    def _setup_gmail_labels(self):
        """Crea etiquetas de Shield en Gmail si no existen"""
        try:
